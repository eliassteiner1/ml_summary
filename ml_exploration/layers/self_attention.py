...
# Neel Nanda, coding gpt-2 from scratch [https://www.youtube.com/watch?v=dsjUDacBw8o]
# Neel notebook[https://colab.research.google.com/github/neelnanda-io/Easy-Transformer/blob/clean-transformer-demo/Clean_Transformer_Demo.ipynb]

# huggingface transformers [https://github.com/huggingface/transformers/tree/main/src/transformers]
